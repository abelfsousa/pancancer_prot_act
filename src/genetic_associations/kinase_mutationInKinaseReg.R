# Estimate the association between kinase-activity and the mutational state of the kinase itself
...
associations <- KA_mut(mutMat = mut, ka = ka, covars = batch, multi_core = F, in_kinase = T)


# write associations
write_tsv(associations, "./output/files/ka_mutStatus_inKinase.txt.gz")
