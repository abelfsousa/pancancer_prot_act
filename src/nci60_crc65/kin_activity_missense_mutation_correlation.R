...
#' # -- assess the impact of missense mutations on kinase activities
...
sift <- sift %>%
  ...
  filter(gene %in% unique(kin_activity$kinase)) %>%
...
missense_impact <- missense_nci60_crc65 %>%
  ...
  #filter(sift < 5) %>%
  ggplot(mapping = aes(x = sift, y = kin_activity)) +
  geom_point() +
...
ggsave(filename = "kin_act_missense_mutation_sift_correlation1.png", plot = missense_impact, path = "./output/plots/nci60_crc65/", width = 6, height = 6)
unlink("kin_act_missense_mutation_sift_correlation1.png")
...
missense_impact <- missense_nci60_crc65 %>%
  ...
  ggplot(mapping = aes(x = sift_factor, y = kin_activity)) +
...
ggsave(filename = "kin_act_missense_mutation_sift_boxplot1.png", plot = missense_impact, path = "./output/plots/nci60_crc65/", width = 6, height = 6)
unlink("kin_act_missense_mutation_sift_boxplot1.png")
...
ggsave(filename = "kin_act_missense_mutation_sift_correlation2.png", plot = missense_impact, path = "./output/plots/nci60_crc65/", width = 6, height = 6)
unlink("kin_act_missense_mutation_sift_correlation2.png")
...
ggsave(filename = "kin_act_missense_mutation_sift_boxplot2.png", plot = missense_impact, path = "./output/plots/nci60_crc65/", width = 6, height = 6)
unlink("kin_act_missense_mutation_sift_boxplot2.png")
