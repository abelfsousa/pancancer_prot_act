...
plot <- net_enrichment2 %>%
  ...
  labs(x = "Association adjusted P-value cutoff (-log10)", y = "Fisher-test P-value (-log10)", title = "Enrichment of kinase-TF activity associations in string physical associations (across edge weights)")

ggsave(filename = "kinase_TFs_associations_string_enrichment_across_pvalues_physical.png", plot = plot, path = "./output/plots/kinase_TF_pathways_associations/", width = 10, height = 6)
ggsave(filename = "kinase_TFs_associations_string_enrichment_across_pvalues_physical.pdf", plot = plot, path = "./output/plots/kinase_TF_pathways_associations/", width = 10, height = 6)
