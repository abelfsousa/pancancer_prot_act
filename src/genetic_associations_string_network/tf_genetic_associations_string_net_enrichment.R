...
ggsave(filename = "tf_genetic_associations_string_enrichment_across_weights.png", plot = plot, path = "./output/plots/genetic_associations_string_network/", width = 4, height = 2)
ggsave(filename = "tf_genetic_associations_string_enrichment_across_weights.pdf", plot = plot, path = "./output/plots/genetic_associations_string_network/", width = 4, height = 2)
unlink("tf_genetic_associations_string_enrichment_across_weights.png")
unlink("tf_genetic_associations_string_enrichment_across_weights.pdf")
