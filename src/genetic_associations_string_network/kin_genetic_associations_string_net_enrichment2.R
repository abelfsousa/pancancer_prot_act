...
ggsave(filename = "kin_genetic_associations_string_enrichment_across_pvalues.png", plot = plot, path = "./output/plots/genetic_associations_string_network/", width = 8, height = 4)
ggsave(filename = "kin_genetic_associations_string_enrichment_across_pvalues.pdf", plot = plot, path = "./output/plots/genetic_associations_string_network/", width = 8, height = 4)
unlink("kin_genetic_associations_string_enrichment_across_pvalues.png")
unlink("kin_genetic_associations_string_enrichment_across_pvalues.pdf")
...
ggsave(filename = "kin_genetic_associations_string_enrichment_across_pvalues2.png", plot = plot, path = "./output/plots/genetic_associations_string_network/", width = 5, height = 3)
ggsave(filename = "kin_genetic_associations_string_enrichment_across_pvalues2.pdf", plot = plot, path = "./output/plots/genetic_associations_string_network/", width = 5, height = 3)


# set of absolute beta cutoffs
ctoffs <- seq(0,2.4,0.1)
...
ggsave(filename = "kin_genetic_associations_string_enrichment_across_betas.png", plot = plot, path = "./output/plots/genetic_associations_string_network/", width = 6, height = 4)
ggsave(filename = "kin_genetic_associations_string_enrichment_across_betas.pdf", plot = plot, path = "./output/plots/genetic_associations_string_network/", width = 6, height = 4)
unlink("kin_genetic_associations_string_enrichment_across_betas.png")
unlink("kin_genetic_associations_string_enrichment_across_betas.pdf")
