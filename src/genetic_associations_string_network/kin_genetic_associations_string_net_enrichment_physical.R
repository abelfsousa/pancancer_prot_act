...
plot <- net_enrichment2 %>%
  ...
  labs(x = "Association adjusted P-value cutoff (-log10)", y = "Fisher-test P-value (-log10)", title = "Enrichment of kinase-mutation associations in string physical associations (across edge weights)")

ggsave(filename = "kin_genetic_associations_string_enrichment_across_pvalues_physical.png", plot = plot, path = "./output/plots/genetic_associations_string_network/", width = 10, height = 6)
ggsave(filename = "kin_genetic_associations_string_enrichment_across_pvalues_physical.pdf", plot = plot, path = "./output/plots/genetic_associations_string_network/", width = 10, height = 6)
