...
string_net_map <- read_tsv(file = "./data/string/9606.protein.info.v11.0.txt.gz")


# load string network
string_net <- data.table::fread(file = "./data/string/9606.protein.links.v11.0.txt.gz") %>%
  as_tibble() %>%
...
write_tsv(string_net, "./output/files/string_network_sorted_pairs.txt.gz")
